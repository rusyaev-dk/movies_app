...
import 'package:movies_app/common/data/clients/account_api_client.dart';
import 'package:movies_app/common/data/clients/auth_api_client.dart';
import 'package:movies_app/common/data/clients/media_api_client.dart';
...
Future<void> registerDependencies() async {
  ...
  GetIt.I.registerSingleton<SearchFiltersRepository>(
      SearchFiltersRepository(keyValueStorage: GetIt.I<SharedPrefsStorage>()));
}
